...
def jac_GRU(GRU_params, hidden, t, X):
    # gradGRU = grad(GRU_forward, argnums=(3))  # <wrt H
...
def XYZpaths(params, t, W, X0):
    ...
    def body(carry, tW):
        ...
        a = grad_forward(FC_params, H1)
        b = jac_GRU(GRU_params, H0, t1, X1)
    ...
    final_state, trace = lax.scan(body, initial, (t, W))  ###the LAX.scan sauce
